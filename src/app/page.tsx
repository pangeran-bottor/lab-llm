            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 xl:inline">Customer Support</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Transform your customer support with intelligent document-based responses. 
                  Upload your knowledge base and let AI provide instant, accurate answers to customer queries.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-gradient-to-r from-blue-500 to-indigo-600 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="text-center text-white">
              ...
              <h2 className="text-3xl font-bold mb-2">Smart AI Assistant</h2>
              <p className="text-xl opacity-90">Powered by advanced language models</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  AI-powered conversations that understand context and provide accurate responses based on your documents.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Upload and manage your knowledge base documents. Support for PDFs and various file formats.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Vector-based search ensures rapid retrieval of relevant information for instant responses.
                </p>
              </div>
            </div>
          </div>
